...
static func set_air_control(value: bool) -> void:
	Config.set_config(GAME_SECTION, AIR_CONTROL, value)

static func is_drag_only_air_control_enabled() -> bool:
	return Config.get_config(GAME_SECTION, AIR_CONTROL, false)
