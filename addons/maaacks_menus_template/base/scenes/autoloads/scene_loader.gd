...
@export_file("*.tscn") var loading_screen_path
...
var _loading_screen : PackedScene = preload("res://src/ui/maaack/loading_screen/loading_screen.tscn")
...
func quick_load_scene(path: String) -> void:
